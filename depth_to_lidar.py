...
def depth_to_lidar(idx_filename, split, dense_depth_dir, pseudo_depth_dir):
    dataset = kitti_object('data/kitti_scrtn_seguv_twise', split)
...
depth_to_lidar( \
    'data/kitti_scrtn_seguv_twise/ImageSets/train.txt',
    'training',
    'data/kitti_scrtn_seguv_twise/training/depth_dense_twise',
    'data/kitti_scrtn_seguv_twise/training/depth_pseudo_rgbseguv_twise'
)

print('---------------Start to generate testing pseudo point clouds---------------')
depth_to_lidar( \
    'data/kitti_scrtn_seguv_twise/ImageSets/test.txt',
    'testing',
    'data/kitti_scrtn_seguv_twise/testing/depth_dense_twise',
    'data/kitti_scrtn_seguv_twise/testing/depth_pseudo_rgbseguv_twise'
)
